...
- **Exploracao em texto + minimapa**: uma unica caixa narrativa no centro
  ...
  masmorra, com pistas nas quatro direcoes) e tambem serve como area de
  dialogo — ao falar com um NPC ou disparar um evento (bau, taverna,
  combate), o mesmo espaco vira a conversa/interacao, com o retrato do
  NPC e os botoes de Continuar/Encerrar aparecendo ali. Um minimapa
  compacto fica fixo no canto, mantendo a neblina de guerra: so o
  caminho ja percorrido aparece, e o conteudo de uma sala (NPC, monstro,
  bau...) so e revelado quando o jogador se aproxima dela.
