...
RPG.UI = (function(){
  ...
  function showEntryPrompt(cell, nx, ny){
    ...
    document.getElementById('dialogueBox').textContent = currentModule().entryText(cell);
  ...
  function confirmNo(){
    ...
    state.mode = 'move';
    state.pendingTarget = null;
    document.getElementById('dialogueBox').textContent = 'Voce decide nao entrar e recua um passo.';
    renderControls();
  }
  ...
  function openDialogueWithNPC(npc){
    ...
    document.getElementById('dialogueBox').textContent = npc.lines[0];
  ...
  function dialogueNext(){
    ...
    document.getElementById('dialogueBox').textContent = currentNPC.lines[npcLineIndex];
  }
  function resetDialogue(){
    currentNPC = null;
    document.getElementById('npcCard').style.display = 'none';
    document.getElementById('dialogueBox').textContent = 'Use os controles de movimento para explorar. NPCs, lojas e perigos so aparecem quando voce se aproxima.';
  }
  function resetDialogueAmbient(){
    currentNPC = null;
    document.getElementById('npcCard').style.display = 'none';
    document.getElementById('dialogueBox').textContent = 'O caminho segue em silencio adiante.';
  }
